...
export const INGEST_ENRICH_PROMPT_VERSION = "v1"
...
const SYSTEM_PROMPT = `You are a knowledge-vault ingest enricher. Given a raw document, produce structured frontmatter + cleaned body markdown + a list of wikilink candidates.
