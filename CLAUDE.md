...
| Skill | Use when |
| :--- | :--- |
| `edit` | User wants to edit posts in Obsidian ("편집", "obsidian 열어", "/edit"). Opens `content/posts` as a vault via `bun run edit` (registry-based exe discovery + 4-tier launch fallback). |
